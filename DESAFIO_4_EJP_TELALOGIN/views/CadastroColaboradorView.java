...
public class CadastroColaboradorView extends Application {
    ...
    {
        stage = estagio;
        FXMLLoader fxmlLoader= new FXMLLoader(getClass().getResource("../modelos/telacadastrocolaborador.fxml"));
