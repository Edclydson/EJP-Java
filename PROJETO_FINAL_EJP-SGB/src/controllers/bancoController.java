...
public class bancoController {
    ...
    public void cadastraColaborador(String nome,String cargo, String salario){
        ...
        do{
            if(cargo.equals("RH")){
                ...
                senhaNova = String.valueOf(geraSenha.nextInt((9999 - 0001)+1)+0001);
            }
    ...
    public String geraMatricula(){
        ...
        do{
            int part1 = geradorMatricula.nextInt(((9999999 - 0000001)+1)+0000001);
            int part2 = geradorMatricula.nextInt(((9999999 - 0000001)+1)+0000001);
